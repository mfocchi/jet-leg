...
comWF = np.array([1.11544276, 0.0453750213, 0.73619278])
comBF = np.array([0.002722627, -0.005904751, -0.0444171])
rpy = np.array([0.039257518, -0.2624996, -0.01198930])

""" contact points in the World Frame"""
LF_foot = np.array([1.484, 0.312, 0.285])
RF_foot = np.array([1.579, -0.344, 0.311])
LH_foot = np.array([0.769, 0.328, 0.094])
RH_foot = np.array([0.864, -0.335, 0.119])
...
trunk_mass = 86.574
mu = 0.5
plane_normal = (-0.2587954, 0.001343170, 0.9659312)
...
n1 = [-0.259, 0.001, 0.966]
n2 = [-0.259, 0.001, 0.966]
n3 = [-0.258, 0.022, 0.965]
n4 = [-0.258, 0.02, 0.965]
...
default_orientation = np.array([-0.0008990495, -0.2649738912, -0.0153784107])
# target_CoM_WF = np.array([1.1642021, 0.0314649, 0.61342885])
target_CoM_WF = np.array([1.22566129, -0.06287036, 0.76374874])
