...
class Go1Model:
    def __init__(self):
        ...
        '''
        LF_tau_lim = [23.7 , 23.7 , 35.55]  # HAA, HFE, KFE
        RF_tau_lim = [23.7 , 23.7 , 35.55]  # HAA, HFE, KFE
        LH_tau_lim = [23.7 , 23.7 , 35.55]  # HAA, HFE, KFE
        RH_tau_lim = [23.7 , 23.7 , 35.55]  # HAA, HFE, KFE
